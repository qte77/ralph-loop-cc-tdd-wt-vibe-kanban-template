...
- [ ] **Reduce complexity in `generate_prd_json.py:646-775`** (complexity=16). Extract helper functions from the long method. Consider: Extract Method, Decompose Conditional patterns.
